...
principal) while **hiding the per-asset split**. 10 Odra contracts, 110 automated tests.
...
## Testing
110 automated tests: 69 unit/regression + 4 live-testnet integration + 20 Playwright
