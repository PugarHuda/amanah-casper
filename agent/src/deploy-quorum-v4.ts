...
import { SessionBuilder, AccountIdentifier, CLValue, CLTypeByteArray, CLTypePublicKey, Args } from "./sdk.js";
...
const STATE = resolve(import.meta.dirname, "../../.env.quorumv4");
const KEY_NAME = "amanah_auditor_quorum_v4_package_hash";
const INSTANCE_ID = "b2".repeat(32).slice(0, 64);
